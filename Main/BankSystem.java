...
public class BankSystem extends JFrame implements ActionListener, ItemListener {
	...
	private JDesktopPane desktop = new JDesktopPane ();
                    System.out.println("Hello ! This is our minor project - BankSystem.");
	...
	public BankSystem () {
		...
		setIconImage (getToolkit().getImage ("Images/Bank.png"));
		setSize (700, 550);
		setJMenuBar (bar);
		...
		delRec = new JMenuItem ("Delete Customer", new ImageIcon ("Images/Delete.png"));
		...
		search = new JMenuItem ("Search By No.", new ImageIcon ("Images/find.png"));
		...
		allCustomer = new JMenuItem ("View All Customer", new ImageIcon ("Images/refresh.png"));
		...
		content = new JMenuItem ("Help Contents", new ImageIcon ("Images/paste.png"));
		...
		about = new JMenuItem ("About BankSystem", new ImageIcon ("Images/Save.png"));
		...
		open = new JMenuItem ("Open New Account", new ImageIcon ("Images/Open.png"));
		open.addActionListener (this);
		report = new JMenuItem ("Print BankSystem Report", new ImageIcon ("Images/New.png"));
		report.addActionListener (this);
		dep = new JMenuItem ("Deposit Money");
		dep.addActionListener (this);
		with = new JMenuItem ("Withdraw Money");
		with.addActionListener (this);
		del = new JMenuItem ("Delete Customer", new ImageIcon ("Images/Delete.png"));
		del.addActionListener (this);
		find = new JMenuItem ("Search Customer", new ImageIcon ("Images/find.png"));
		find.addActionListener (this);
		all = new JMenuItem ("View All Customer", new ImageIcon ("Images/refresh.png"));
		...
		btnNew = new JButton (new ImageIcon ("Images/NotePad.png"));
		btnNew.setToolTipText ("Create New Account");
		btnNew.addActionListener (this);
		btnDep = new JButton (new ImageIcon ("Images/ImationDisk.png"));
		btnDep.setToolTipText ("Deposit Money");
		btnDep.addActionListener (this);
		btnWith = new JButton (new ImageIcon ("Images/SuperDisk.png"));
		btnWith.setToolTipText ("Withdraw Money");
		btnWith.addActionListener (this);
		btnRec = new JButton (new ImageIcon ("Images/Paproll.png"));
		btnRec.setToolTipText ("Print Customer Balance");
		btnRec.addActionListener (this);
		btnDel = new JButton (new ImageIcon ("Images/Toaster.png"));
		btnDel.setToolTipText ("Delete Customer");
		btnDel.addActionListener (this);
		btnSrch = new JButton (new ImageIcon ("Images/Search.png"));
		...
		btnKey = new JButton (new ImageIcon ("Images/Keys.png"));
	...
	public void actionPerformed (ActionEvent ae) {
		...
		if (obj == addNew || obj == open || obj == btnNew) {
			...
			String msg = "BankSystem\n\n" + "Created & Designed By:\n" + 
				"Nilotpal Goyal and Nivedita Rawal\n\n" + "E-mail me:\n gmailAddress@gmail.com";
